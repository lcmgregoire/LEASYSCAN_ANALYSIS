...
end=which(rownames(TR_profiles) == "17.10.2023.23.45") ##change pour la fin de manip ! 
...
start_irr_day=which(rownames(TR_trial_period) == "29.09.2023.00.00")
end_irr_day=which(rownames(TR_trial_period) == "29.09.2023.23.45")
...
#     if (isTRUE(subset_geno_trt[j,1] > 1) ||  (isTRUE(subset_geno_trt[j,1] < -1))){
...
g=geno_info$Geno_Trt
g_t=g[1]
#select all columns that contain "genotype name" 
subset_geno = TR_profiles[,grepl(g_t,names(TR_profiles))]
...
features_d2<-read.csv("C:/Users/2021lg003/Documents/LEASYSCAN_ANALYSIS/2-DATA_SMOOTHING/results/PERIODE1/smthTR_FeaturesTimeSeries/D.2023-09-28.csv")
features_d3<-read.csv("C:/Users/2021lg003/Documents/LEASYSCAN_ANALYSIS/2-DATA_SMOOTHING/results/PERIODE1/smthTR_FeaturesTimeSeries/D.2023-09-29.csv")
...
colnames(features_d2)=c( "X","unit", "old_unit","Treatment","Genotype", "G..Alias", "Replicates", "MAXET-2023-09-28" ,"slope.maxET.6-2023-09-28", "slope.07.maxET-2023-09-28","slope.00.07-2023-09-28", "slope.19.23.45-2023-09-28", "curvmaxET-2023-09-28","total.auc-2023-09-28","auc.10.15-2023-09-28" , "sd.10.15-2023-09-28","auc.prop.10.15-2023-09-28", "auc.07.19-2023-09-28", "sd.07.19-2023-09-28",   "auc.prop.07.19-2023-09-28", "auc.night-2023-09-28","cos.sim.index-2023-09-28")


colnames(features_d3)=c( "X","unit", "old_unit","Treatment","Genotype", "G..Alias", "Replicates", "MAXET-2023-09-28" ,"slope.maxET.6-2023-09-28", "slope.07.maxET-2023-09-28","slope.00.07-2023-09-28", "slope.19.23.45-2023-09-28", "curvmaxET-2023-09-28","total.auc-2023-09-28","auc.10.15-2023-09-28" , "sd.10.15-2023-09-28","auc.prop.10.15-2023-09-28", "auc.07.19-2023-09-28", "sd.07.19-2023-09-28",   "auc.prop.07.19-2023-09-28", "auc.night-2023-09-28","cos.sim.index-2023-09-28")

###BIND ALL DATES 
features<-cbind(features_d2, features_d3)
...
slope.seven.maxET=features[,grepl("slope.07.maxET",names(features))]
